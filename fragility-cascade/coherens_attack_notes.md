# coherens_attack_notes.md

Design essay accompanying [`coherens_attack.py`](coherens_attack.py) — the six
attacks the code encodes as stress tests, with counter-arguments and
responses. Split from the .py file because it contained nested markdown
"""code fences""" that terminated the surrounding string literal in Python.
