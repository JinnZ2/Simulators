"""
Tensor Field of Institutional Resilience v1.

Four vectors: F (Feedback), A (Audit), T (Forensic), M (Meta-Awareness).
Models the tugs and pulls of institutional governance under external
stressors (AI acceleration, theological schism, etc.). v2 in this
folder extends the tensor with G/W/Y anchors.

CC0. Extracted verbatim from legacy/Organize3.md lines 3456-3645.
